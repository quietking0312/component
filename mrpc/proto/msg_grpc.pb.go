...
const (
	Service_SayHello_FullMethodName = "/proto.Service/SayHello"
)
...
func (c *serviceClient) SayHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (UnimplementedServiceServer) SayHello(context.Context, *HelloReq) (*HelloReply, error) {
...
func _Service_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).SayHello(ctx, req.(*HelloReq))
	}
